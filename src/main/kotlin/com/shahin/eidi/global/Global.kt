package com.shahin.eidi.global
...
import com.shahin.eidi.DEFAULT_AM
import com.shahin.eidi.DEFAULT_ASCENDING_ATHAN_VOLUME
import com.shahin.eidi.DEFAULT_ATHAN_VIBRATION
import com.shahin.eidi.DEFAULT_AZERI_ALTERNATIVE_PERSIAN_MONTHS
import com.shahin.eidi.DEFAULT_CITY
import com.shahin.eidi.DEFAULT_DREAM_NOISE
import com.shahin.eidi.DEFAULT_EASTERN_GREGORIAN_ARABIC_MONTHS
import com.shahin.eidi.DEFAULT_ENGLISH_GREGORIAN_PERSIAN_MONTHS
import com.shahin.eidi.DEFAULT_HIGH_LATITUDES_METHOD
import com.shahin.eidi.DEFAULT_HOLIDAY
import com.shahin.eidi.DEFAULT_IRAN_TIME
import com.shahin.eidi.DEFAULT_ISLAMIC_OFFSET
import com.shahin.eidi.DEFAULT_LOCAL_DIGITS
import com.shahin.eidi.DEFAULT_NOTIFY_DATE
import com.shahin.eidi.DEFAULT_NOTIFY_DATE_LOCK_SCREEN
import com.shahin.eidi.DEFAULT_PM
import com.shahin.eidi.DEFAULT_PRAY_TIME_METHOD
import com.shahin.eidi.DEFAULT_RED_HOLIDAYS
import com.shahin.eidi.DEFAULT_SECONDARY_CALENDAR_IN_TABLE
import com.shahin.eidi.DEFAULT_THEME_GRADIENT
import com.shahin.eidi.DEFAULT_VAZIR_ENABLED
import com.shahin.eidi.DEFAULT_WALLPAPER_AUTOMATIC
import com.shahin.eidi.DEFAULT_WALLPAPER_DARK
import com.shahin.eidi.DEFAULT_WIDGET_CLOCK
import com.shahin.eidi.DEFAULT_WIDGET_CUSTOMIZATIONS
import com.shahin.eidi.DEFAULT_WIDGET_IN_24
import com.shahin.eidi.DEFAULT_WIDGET_TRANSPARENCY
...
import com.shahin.eidi.PREF_ASTRONOMICAL_FEATURES
import com.shahin.eidi.PREF_ATHAN_NAME
import com.shahin.eidi.PREF_ATHAN_VIBRATION
import com.shahin.eidi.PREF_AZERI_ALTERNATIVE_PERSIAN_MONTHS
import com.shahin.eidi.PREF_CALENDARS_IDS_AS_HOLIDAY
import com.shahin.eidi.PREF_CALENDARS_IDS_TO_EXCLUDE
import com.shahin.eidi.PREF_CENTER_ALIGN_WIDGETS
import com.shahin.eidi.PREF_DREAM_NOISE
import com.shahin.eidi.PREF_EASTERN_GREGORIAN_ARABIC_MONTHS
import com.shahin.eidi.PREF_ENGLISH_GREGORIAN_PERSIAN_MONTHS
...
import com.shahin.eidi.PREF_ISLAMIC_OFFSET
...
import com.shahin.eidi.PREF_SHOW_DEVICE_CALENDAR_EVENTS
...
import com.shahin.eidi.PREF_WALLPAPER_AUTOMATIC
import com.shahin.eidi.PREF_WALLPAPER_DARK
...
import com.shahin.eidi.ui.calendar.SwipeDownAction
import com.shahin.eidi.ui.calendar.SwipeUpAction
...
import com.shahin.eidi.utils.getJdnOrNull
import com.shahin.eidi.utils.isIslamicOffsetExpired
import com.shahin.eidi.utils.logException
import com.shahin.eidi.utils.preferences
import com.shahin.eidi.utils.scheduleAlarms
import com.shahin.eidi.utils.splitFilterNotEmpty
